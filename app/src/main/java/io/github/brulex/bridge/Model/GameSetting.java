...
public class GameSetting {
    ...
    public GameSetting(int i_setting, String game_name, int current_round,
                       Boolean flag_lower_card, Boolean flag_spades_jack,
                       Boolean flag_spades_queen, Boolean flag_point_change,
                       int cost_the6, int cost_the7, int cost_the8,
                       int cost_the9, int cost_the10, int cost_Jack,
                       int cost_Spades_of_Jack, int cost_Queen, int cost_Spades_of_Queen,
                       int cost_King, int cost_Ace, List<Player> players) {
