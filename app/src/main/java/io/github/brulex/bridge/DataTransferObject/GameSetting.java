...
public class GameSetting {
    ...
    private int cost_the6, cost_the7, cost_the8, cost_the9, cost_the10;
    private int cost_Jack, cost_Spades_of_Jack, cost_Queen, cost_Spades_of_Queen, cost_King, cost_Ace;
